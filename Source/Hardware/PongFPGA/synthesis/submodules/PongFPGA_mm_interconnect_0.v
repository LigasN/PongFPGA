...
module PongFPGA_mm_interconnect_0 (
	...
	wire  [84:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_agent:rp_data
	...
	wire  [84:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire  [85:0] nios_debug_mem_slave_agent_rf_source_data;                                  // NIOS_debug_mem_slave_agent:rf_source_data -> NIOS_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [85:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // NIOS_debug_mem_slave_agent_rsp_fifo:out_data -> NIOS_debug_mem_slave_agent:rf_sink_data
	...
	wire  [84:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> NIOS_debug_mem_slave_agent:cp_data
	...
	wire  [85:0] pll_pll_slave_agent_rf_source_data;                                         // PLL_pll_slave_agent:rf_source_data -> PLL_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [85:0] pll_pll_slave_agent_rsp_fifo_out_data;                                      // PLL_pll_slave_agent_rsp_fifo:out_data -> PLL_pll_slave_agent:rf_sink_data
	...
	wire  [84:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> PLL_pll_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                      // PLL_pll_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> PLL_pll_slave_agent:cp_channel
	...
	wire  [84:0] nios_data_master_agent_cp_data;                                             // NIOS_data_master_agent:cp_data -> router:sink_data
	...
	wire  [84:0] nios_instruction_master_agent_cp_data;                                      // NIOS_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [84:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [84:0] pll_pll_slave_agent_rp_data;                                                // PLL_pll_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [84:0] router_003_src_data;                                                        // router_003:src_data -> rsp_demux_001:sink_data
	...
	wire  [84:0] cmd_demux_src1_data;                                                        // cmd_demux:src1_data -> crosser:in_data
	...
	wire  [84:0] crosser_out_data;                                                           // crosser:out_data -> cmd_mux_001:sink0_data
	...
	wire  [84:0] rsp_demux_001_src0_data;                                                    // rsp_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [84:0] crosser_001_out_data;                                                       // crosser_001:out_data -> rsp_mux:sink1_data
	...
	PongFPGA_mm_interconnect_0_router router (
	...
	PongFPGA_mm_interconnect_0_router_001 router_001 (
	...
	PongFPGA_mm_interconnect_0_router_002 router_002 (
	...
	PongFPGA_mm_interconnect_0_router_003 router_003 (
	...
	PongFPGA_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (PLL_c0_clk),                             //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (PLL_c0_clk),                             //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (PLL_c0_clk),                             //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (CLK_clk_clk),                                           //       clk.clk
		.reset               (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (PLL_c0_clk),                             //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (CLK_clk_clk),                                           //       clk.clk
		.reset              (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (PLL_c0_clk),                             //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (PLL_c0_clk),                             //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
