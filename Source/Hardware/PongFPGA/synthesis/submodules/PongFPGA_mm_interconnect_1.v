...
module PongFPGA_mm_interconnect_1 (
		...
		input  wire [12:0] NIOS_data_master_address,                              //                                NIOS_data_master.address
	...
	wire  [12:0] nios_data_master_translator_avalon_universal_master_0_address;              // NIOS_data_master_translator:uav_address -> NIOS_data_master_agent:av_address
	...
	wire  [86:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_agent:rp_data
	...
	wire  [12:0] nios_instruction_master_translator_avalon_universal_master_0_address;       // NIOS_instruction_master_translator:uav_address -> NIOS_instruction_master_agent:av_address
	...
	wire  [86:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire  [12:0] nios_debug_mem_slave_agent_m0_address;                                      // NIOS_debug_mem_slave_agent:m0_address -> NIOS_debug_mem_slave_translator:uav_address
	...
	wire  [87:0] nios_debug_mem_slave_agent_rf_source_data;                                  // NIOS_debug_mem_slave_agent:rf_source_data -> NIOS_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [87:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // NIOS_debug_mem_slave_agent_rsp_fifo:out_data -> NIOS_debug_mem_slave_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> NIOS_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                          // NIOS_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [2:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire  [12:0] pll_pll_slave_agent_m0_address;                                             // PLL_pll_slave_agent:m0_address -> PLL_pll_slave_translator:uav_address
	...
	wire  [87:0] pll_pll_slave_agent_rf_source_data;                                         // PLL_pll_slave_agent:rf_source_data -> PLL_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [87:0] pll_pll_slave_agent_rsp_fifo_out_data;                                      // PLL_pll_slave_agent_rsp_fifo:out_data -> PLL_pll_slave_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> PLL_pll_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                      // PLL_pll_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> PLL_pll_slave_agent:cp_channel
	...
	wire  [12:0] vram_s1_agent_m0_address;                                                   // VRAM_s1_agent:m0_address -> VRAM_s1_translator:uav_address
	...
	wire  [60:0] vram_s1_agent_rf_source_data;                                               // VRAM_s1_agent:rf_source_data -> VRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [60:0] vram_s1_agent_rsp_fifo_out_data;                                            // VRAM_s1_agent_rsp_fifo:out_data -> VRAM_s1_agent:rf_sink_data
	...
	wire  [86:0] nios_data_master_agent_cp_data;                                             // NIOS_data_master_agent:cp_data -> router:sink_data
	...
	wire  [86:0] nios_instruction_master_agent_cp_data;                                      // NIOS_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [86:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [86:0] pll_pll_slave_agent_rp_data;                                                // PLL_pll_slave_agent:rp_data -> router_003:sink_data
	...
	wire         vram_s1_agent_rp_valid;                                                     // VRAM_s1_agent:rp_valid -> router_004:sink_valid
	wire  [59:0] vram_s1_agent_rp_data;                                                      // VRAM_s1_agent:rp_data -> router_004:sink_data
	wire         vram_s1_agent_rp_ready;                                                     // router_004:sink_ready -> VRAM_s1_agent:rp_ready
	wire         vram_s1_agent_rp_startofpacket;                                             // VRAM_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         vram_s1_agent_rp_endofpacket;                                               // VRAM_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire         vram_s1_burst_adapter_source0_valid;                                        // VRAM_s1_burst_adapter:source0_valid -> VRAM_s1_agent:cp_valid
	wire  [59:0] vram_s1_burst_adapter_source0_data;                                         // VRAM_s1_burst_adapter:source0_data -> VRAM_s1_agent:cp_data
	wire         vram_s1_burst_adapter_source0_ready;                                        // VRAM_s1_agent:cp_ready -> VRAM_s1_burst_adapter:source0_ready
	wire   [2:0] vram_s1_burst_adapter_source0_channel;                                      // VRAM_s1_burst_adapter:source0_channel -> VRAM_s1_agent:cp_channel
	...
	wire  [86:0] cmd_demux_001_src1_data;                                                    // cmd_demux_001:src1_data -> cmd_mux_002:sink1_data
	...
	wire  [86:0] rsp_demux_002_src1_data;                                                    // rsp_demux_002:src1_data -> rsp_mux_001:sink1_data
	...
	wire         router_004_src_valid;                                                       // router_004:src_valid -> VRAM_s1_rsp_width_adapter:in_valid
	wire  [59:0] router_004_src_data;                                                        // router_004:src_data -> VRAM_s1_rsp_width_adapter:in_data
	wire         router_004_src_ready;                                                       // VRAM_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire   [2:0] router_004_src_channel;                                                     // router_004:src_channel -> VRAM_s1_rsp_width_adapter:in_channel
	wire         router_004_src_startofpacket;                                               // router_004:src_startofpacket -> VRAM_s1_rsp_width_adapter:in_startofpacket
	wire         router_004_src_endofpacket;                                                 // router_004:src_endofpacket -> VRAM_s1_rsp_width_adapter:in_endofpacket
	wire         vram_s1_rsp_width_adapter_src_valid;                                        // VRAM_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [86:0] vram_s1_rsp_width_adapter_src_data;                                         // VRAM_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire         vram_s1_rsp_width_adapter_src_ready;                                        // rsp_demux_002:sink_ready -> VRAM_s1_rsp_width_adapter:out_ready
	wire   [2:0] vram_s1_rsp_width_adapter_src_channel;                                      // VRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire         vram_s1_rsp_width_adapter_src_startofpacket;                                // VRAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire         vram_s1_rsp_width_adapter_src_endofpacket;                                  // VRAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire         cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> VRAM_s1_cmd_width_adapter:in_valid
	wire  [86:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> VRAM_s1_cmd_width_adapter:in_data
	wire         cmd_mux_002_src_ready;                                                      // VRAM_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> VRAM_s1_cmd_width_adapter:in_channel
	wire         cmd_mux_002_src_startofpacket;                                              // cmd_mux_002:src_startofpacket -> VRAM_s1_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                // cmd_mux_002:src_endofpacket -> VRAM_s1_cmd_width_adapter:in_endofpacket
	wire         vram_s1_cmd_width_adapter_src_valid;                                        // VRAM_s1_cmd_width_adapter:out_valid -> VRAM_s1_burst_adapter:sink0_valid
	wire  [59:0] vram_s1_cmd_width_adapter_src_data;                                         // VRAM_s1_cmd_width_adapter:out_data -> VRAM_s1_burst_adapter:sink0_data
	wire         vram_s1_cmd_width_adapter_src_ready;                                        // VRAM_s1_burst_adapter:sink0_ready -> VRAM_s1_cmd_width_adapter:out_ready
	wire   [2:0] vram_s1_cmd_width_adapter_src_channel;                                      // VRAM_s1_cmd_width_adapter:out_channel -> VRAM_s1_burst_adapter:sink0_channel
	...
	wire  [86:0] cmd_demux_src1_data;                                                        // cmd_demux:src1_data -> crosser:in_data
	...
	wire  [86:0] crosser_out_data;                                                           // crosser:out_data -> cmd_mux_001:sink0_data
	...
	wire  [86:0] rsp_demux_001_src0_data;                                                    // rsp_demux_001:src0_data -> crosser_001:in_data
	wire         rsp_demux_001_src0_ready;                                                   // crosser_001:in_ready -> rsp_demux_001:src0_ready
	wire   [2:0] rsp_demux_001_src0_channel;                                                 // rsp_demux_001:src0_channel -> crosser_001:in_channel
	...
	wire  [86:0] crosser_001_out_data;                                                       // crosser_001:out_data -> rsp_mux:sink1_data
	wire         crosser_001_out_ready;                                                      // rsp_mux:sink1_ready -> crosser_001:out_ready
	wire   [2:0] crosser_001_out_channel;                                                    // crosser_001:out_channel -> rsp_mux:sink1_channel
	...
	wire         vram_s1_agent_rdata_fifo_src_valid;                                         // VRAM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [9:0] vram_s1_agent_rdata_fifo_src_data;                                          // VRAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         vram_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_002:in_0_ready -> VRAM_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                          // avalon_st_adapter_002:out_0_valid -> VRAM_s1_agent:rdata_fifo_sink_valid
	wire   [9:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> VRAM_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                          // VRAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                          // avalon_st_adapter_002:out_0_error -> VRAM_s1_agent:rdata_fifo_sink_error
	...
	PongFPGA_mm_interconnect_1_router_004 router_004 (
	...
	PongFPGA_mm_interconnect_1_cmd_demux_001 rsp_demux (
		.clk                (PLL_c0_clk),                             //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (CLK_clk_clk),                                           //       clk.clk
		.reset              (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PongFPGA_mm_interconnect_1_cmd_demux_001 rsp_demux_002 (
		.clk                (PLL_c0_clk),                                  //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	PongFPGA_mm_interconnect_1_avalon_st_adapter_002 #(
		.inBitsPerSymbol (10),
		.inUsePackets    (0),
		.inDataWidth     (10),
		.inChannelWidth  (0),
